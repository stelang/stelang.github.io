        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Sid Telang</a></h1>
              <span className="email"><i className="icon-mail"></i> siddharth_telang@yahoo.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://github.com/stelang" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
              </ul> 
            </nav>
